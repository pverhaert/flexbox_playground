        ...
        <Draggable nodeRef={nodeRef} handle=".drag-handle" bounds="parent" onStart={onFocus}>
            ...
            >
                ...
                >
                    <>
                        {/* Header / Drag Handle */}
                        <div className="drag-handle bg-green-200 dark:bg-green-900/50 p-3 border-b border-green-300 dark:border-green-800 cursor-move flex items-center justify-between group shrink-0">
